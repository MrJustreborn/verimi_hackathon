...
public class ApiClient {
    ...
    private String basePath = "https://verimi.com/dipp/api/";
    ...
    public ApiClient() {
        ...
        authentications.put("sdk_auth", new OAuth());
        authentications.put("sdk_simple", new HttpBasicAuth());
     ...
     * Set base path
     *
     * @param basePath Base path of the URL (e.g https://verimi.com/dipp/api/
