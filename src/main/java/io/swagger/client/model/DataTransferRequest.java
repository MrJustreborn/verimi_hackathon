...
public class DataTransferRequest   {
  @SerializedName("externalIdentityOwnerId")
  private String externalIdentityOwnerId = null;

  @SerializedName("dataScopes")
  private List<ScopeData> dataScopes = new ArrayList<ScopeData>();

  public DataTransferRequest externalIdentityOwnerId(String externalIdentityOwnerId) {
    this.externalIdentityOwnerId = externalIdentityOwnerId;
    return this;
  }

   /**
   * Get externalIdentityOwnerId
   * @return externalIdentityOwnerId
  **/
  @ApiModelProperty(example = "null", value = "")
  public String getExternalIdentityOwnerId() {
    return externalIdentityOwnerId;
  }

  public void setExternalIdentityOwnerId(String externalIdentityOwnerId) {
    this.externalIdentityOwnerId = externalIdentityOwnerId;
  }

  public DataTransferRequest dataScopes(List<ScopeData> dataScopes) {
    this.dataScopes = dataScopes;
    return this;
  }

  public DataTransferRequest addDataScopesItem(ScopeData dataScopesItem) {
    this.dataScopes.add(dataScopesItem);
    return this;
  }
   ...
   * @return dataScopes
  **/
  @ApiModelProperty(example = "null", value = "User Scope Data.")
  public List<ScopeData> getDataScopes() {
    return dataScopes;
  }

  public void setDataScopes(List<ScopeData> dataScopes) {
    this.dataScopes = dataScopes;
  }
  ...
  public boolean equals(java.lang.Object o) {
    ...
    DataTransferRequest dataTransferRequest = (DataTransferRequest) o;
    return Objects.equals(this.externalIdentityOwnerId, dataTransferRequest.externalIdentityOwnerId) &&
        Objects.equals(this.dataScopes, dataTransferRequest.dataScopes);
  }

  @Override
  public int hashCode() {
    return Objects.hash(externalIdentityOwnerId, dataScopes);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class DataTransferRequest {\n");
    
    sb.append("    externalIdentityOwnerId: ").append(toIndentedString(externalIdentityOwnerId)).append("\n");
    sb.append("    dataScopes: ").append(toIndentedString(dataScopes)).append("\n");
    sb.append("}");
    return sb.toString();
  }
