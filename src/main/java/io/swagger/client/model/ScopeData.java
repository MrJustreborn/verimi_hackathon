...
public class ScopeData   {
  ...
  @SerializedName("data")
  private List<DataField> data = new ArrayList<DataField>();

  public ScopeData scopeId(String scopeId) {
   ...
   * @return scopeId
  **/
  @ApiModelProperty(example = "null", value = "Data scope id.")
  ...
  public ScopeData data(List<DataField> data) {
    this.data = data;
    return this;
  }

  public ScopeData addDataItem(DataField dataItem) {
   ...
   * @return data
  **/
  @ApiModelProperty(example = "null", value = "Scope data.")
  ...
  public boolean equals(java.lang.Object o) {
    ...
    return Objects.equals(this.scopeId, scopeData.scopeId) &&
        Objects.equals(this.data, scopeData.data);
  }

  @Override
  public int hashCode() {
    return Objects.hash(scopeId, data);
  }
