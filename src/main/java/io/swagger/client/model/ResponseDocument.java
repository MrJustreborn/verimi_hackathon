...
import io.swagger.client.model.ResponseMeta;
 ...
 */
@ApiModel(description = "A JSON object MUST be at the root of every JSON API response containing data.  This object defines a document’s \"top level\".  ")
...
public class ResponseDocument   {
  ...
  public ResponseDocument data(Object data) {
    this.data = data;
    return this;
  }
   ...
   * @return data
  **/
  @ApiModelProperty(example = "null", value = "The document’s \"primary data\"")
  ...
  public ResponseDocument errors(List<ResponseError> errors) {
    this.errors = errors;
    return this;
  }

  public ResponseDocument addErrorsItem(ResponseError errorsItem) {
   ...
   * @return errors
  **/
  @ApiModelProperty(example = "null", value = "An array of error objects")
  ...
  public ResponseDocument meta(ResponseMeta meta) {
    this.meta = meta;
    return this;
  }
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    return Objects.equals(this.data, responseDocument.data) &&
        Objects.equals(this.errors, responseDocument.errors) &&
        Objects.equals(this.meta, responseDocument.meta);
  }
  ...
  public String toString() {
    ...
    sb.append("class ResponseDocument {\n");
