...
import io.swagger.client.model.ErrorResponseElement;
...
public class ErrorResponse   {
  ...
  private List<ErrorResponseElement> errors = new ArrayList<ErrorResponseElement>();

  public ErrorResponse errors(List<ErrorResponseElement> errors) {
    this.errors = errors;
    return this;
  }

  public ErrorResponse addErrorsItem(ErrorResponseElement errorsItem) {
